	...
	<footer class="entry-footer">
		<?php
			...
			if ( ! pictorico_categorized_blog() ) {
				...
				if ( '' != $tag_list ) {
					$meta_text = __( 'Skills used: %2$s. Bookmark the <a href="%3$s" rel="bookmark">permalink</a>.', 'pictorico' );
				} else {
				...
				if ( '' != $tag_list ) {
					$meta_text = __( 'Skills used: %1$s and tagged %2$s.', 'pictorico' );
				} else {
					$meta_text = __( 'Skills used: %1$s. Bookmark the <a href="%3$s" rel="bookmark">permalink</a>.', 'pictorico' );
				}
