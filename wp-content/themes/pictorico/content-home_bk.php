...
<li>
    <div <?php post_class( $postclass." ch-item"); ?> style="background-image: url(<?php $post_thumbnail_id = get_post_thumbnail_id( get_the_ID() ); echo wp_get_attachment_url($post_thumbnail_id); ?> )">
        <div class="ch-info">
